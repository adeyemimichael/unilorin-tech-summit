...
<motion.h1 className='text-[#fff] mt-24  md:mt-0 text-center md:text-center font-bold md:text-[46px] text-[30px] mx-6 md:pt-12 '
initial={{
  x:-100, opacity:0
}}
...
>A Global <br></br> Tech Event in a University </motion.h1>
...
<motion.p className='text-center text-[#b5fc1d] p-2 mb-10 text-[20px] font-semibold ml-4'
 initial={{
  x:200, opacity:0
}}
animate={{x:-10, opacity:1}}
...
<img src={back} alt="" className='absolute opacity-5 object-cover'  />
  ...
  transition={{delay:1, duration:2
    ...
    <motion.h1 className=' text-[#b5fc1d] md:font-semibold md:text-[24px] pb-3 font-bold text-[30px] pt-4'
  ...
  transition={{delay:1, duration:2
   ...
   >What is Unilorin Tech Summit</motion.h1>
      <motion.p className='text-[#fff]  text-[18px] md:text-xl  mb-2'
      initial={{
    x:200, opacity:0
  }}
  animate={{x:-10, opacity:1}}
  transition={{duration:2
   ...
   university in Nigeria with over 40,000 students.
    ...
    <motion.p className='pt-4 text-[#fff]  text-[18px] md:text-xl'
     initial={{
      x:200, opacity:0
    }}
    animate={{x:-10, opacity:1}}
    transition={{duration:2
     ...
     <motion.p className='pt-4 text-[#fff]  text-[px18] md:text-xl pb-8'
     initial={{
      x:200, opacity:0
    }}
    animate={{x:-10, opacity:1}}
    ...
    <div className='h-fit'>
      ...
      <div className='bg-[#b5fc1d] md:w-40 md:h-40 ml-8 w-fit h-fit pb-4 p-4 rounded-2xl  text-center flex
      ...
      Speakers</span></div>
      <div className='bg-[#b5fc1d] md:w-44 md:h-44  w-fit h-fit pb-4 p-4 rounded-2xl mx-2 text-center flex flex-col items-center justify-center mb-4'><h1 className='text-[#000038]  font-bold text-center text-[40px]'>2000+</h1>
      <span className='text-[16px] md:text-[20px] font-semibold'>Young minds</span>
      </div>
      <div className='bg-[#b5fc1d] md:w-40 md:h-40  w-fit h-fit pb-4 p-4 rounded-2xl mr-8 text-center flex
      flex-col justify-center  items-center'><h1 className='text-[#000038]  font-bold text-center  text-[30px] md:text-[40px]'>8</h1>
      <span  className='text-[14px] md:text-[20px] font-semibold'>Panelists</span></div>
    </div>
    </div>
       </div>
...
<Link to='https://twitter.com/Uiltechsummit'><AiOutlineTwitter className='m-1 rounded-lg cursor-pointer text-[#000038] hover:text-[#b5fc1d]' size={30}/></Link>
<Link to='https://instagram.com/unilorintechsummit'><AiOutlineInstagram className='m-1 rounded-lg cursor-pointertext-[#000038] hover:text-[#b5fc1d]' size={30}/></Link>
<AiOutlineMail className='m-1 rounded-lg cursor-pointer text-[#000038] hover:text-[#b5fc1d]' size={30} onClick={handleMailClick} />
<Link to="https://www.linkedin.com/company/unilorin-tech-summit/"><AiOutlineLinkedin className='m-1 rounded-lg cursor-pointer text-[#000038] hover:text-[#b5fc1d]' size={30}/></Link>
</div>
